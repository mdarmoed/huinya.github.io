...
function MainBlock() {
  return (
    /*Photo with cat,Galeria Our Cat, ... */
    <>
      ...
      <section className=''>
        <div style={{ textAlign: "center" }}>
          <h1>Наши котики</h1>
          <p>Бедные голодные cats ищут себе новых хозяев и нуждаются в вашей помощи. <br/>
            Мы поможем выбрать питомца из приюта и подготовиться к его переезду. </p>
        </div>
        <br />
        <div className='container'>
